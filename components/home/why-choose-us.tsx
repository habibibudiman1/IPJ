...
import { Wrench, Globe, MapPin, ShieldCheck, Truck } from "lucide-react";
...
export function WhyChooseUs() {
  ...
  const advantagesList = [
    ...
    {
      icon: Globe,
      title: t("localExpertise.title"),
      description: t("localExpertise.description"),
    },
    {
      icon: MapPin,
      title: t("strategicLocation.title"),
      description: t("strategicLocation.description"),
    },
    {
      icon: ShieldCheck,
      title: t("consistentQuality.title"),
      description: t("consistentQuality.description"),
    },
    {
      icon: Truck,
      title: t("responsiveSupport.title"),
      description: t("responsiveSupport.description"),
    },
  ];
  ...
  return (
    <section id="whyus" className="relative py-24 lg:py-36 bg-brand-green overflow-hidden">
      ...
      >
        <span
          className="font-display font-bold text-white/3 leading-none"
      ...
      {/* Subtle top border */}
      <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-brand-saffron/30 to-transparent" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-[1fr_1.5fr] gap-12 lg:gap-24 items-start mb-20">
            <div>
              ...
              >
                Why Choose <span className="italic text-brand-saffron">Us</span>
              </motion.h2>
            </div>
          ...
          <div className="space-y-0 divide-y divide-white/[0.07]">
            {advantagesList.map((adv, i) => (
              <motion.div
                ...
                className="group grid grid-cols-[80px_1fr_auto] lg:grid-cols-[120px_1fr_auto] items-center gap-6 lg:gap-12 py-8 cursor-default hover:bg-white/3 -mx-4 px-4 lg:-mx-8 lg:px-8 rounded-xl transition-colors duration-300"
              >
                {/* Large number */}
                <span
                  className="font-display font-bold text-white/8 group-hover:text-brand-saffron/25 transition-colors duration-500 leading-none select-none"
      ...
      <div className="absolute bottom-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-brand-saffron/20 to-transparent" />
    </section>
  );
}
